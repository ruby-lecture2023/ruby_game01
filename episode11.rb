...
sekimen3_img = Image.load("image/character/sekimen03.png") # 赤面その３
sekimen2_img = Image.load("image/character/sekimen02.png") # 赤面その２

# その他画像設定
back_img = Image.load("image/back/kyousitu01.jpg") # 背景（教室）
...
Window.loop do
    ...
    # 背景の表示
    Window.draw_scale(0, 0, myroom_img, 0.2, 0.2, 0, 0) # トリム済主人公自宅背景
    ...
    when 3
        Window.draw_scale(19, 374, window_img, 0.5, 0.5, 0, 0)
        Window.draw_font(109, 374, "氷見鏡子", font_name, color:[255, 255, 255])
        Window.draw_font(44, 404, "、７、８、９、１０個。全部できたわ！", font, color:[165, 83, 126])
        if Input.mouse_push?(M_LBUTTON)
            flag2 =4
        end
    when 4
